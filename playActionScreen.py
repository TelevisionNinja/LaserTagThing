...
class Ui_PlayActionWindow(object):
    def setupUi(self, PlayActionWindow):
        ...
        self.currentAction.setGeometry(QtCore.QRect(90, 280, 801, 180))
        ...
        self.timeRemaining.setGeometry(QtCore.QRect(600, 460, 291, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.timeRemaining.setFont(font)
        self.timeRemaining.setReadOnly(True)
        self.timeRemaining.setObjectName("timeRemaining")
        self.highScore1 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.highScore1.setGeometry(QtCore.QRect(90, 241, 400, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.highScore1.setFont(font)
        self.highScore1.setReadOnly(True)
        self.highScore1.setObjectName("highScore1")
        self.highScore2 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.highScore2.setGeometry(QtCore.QRect(490, 241, 400, 40))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.highScore2.setFont(font)
        self.highScore2.setReadOnly(True)
        self.highScore2.setObjectName("highScore2")
    ...
    def retranslateUi(self, PlayActionWindow):
        ...
        self.highScore1.setPlainText(_translate("PlayActionWindow", "High Score: "))
        self.highScore2.setPlainText(_translate("PlayActionWindow", "High Score: "))
